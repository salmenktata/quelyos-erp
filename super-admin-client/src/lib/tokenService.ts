/**
 * Token Service - Gestion JWT pour Super Admin
 *
 * Gère :
...
// Constants
const STORAGE_KEY = 'quelyos_auth'
...
class TokenService {
   ...
   */
  setTokens(accessToken: string, expiresIn: number, user?: { id: number; name: string; login: string; tenant_id?: number; tenant_domain?: string }) {
