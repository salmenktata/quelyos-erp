...
const TrustBadgeItem = memo(({ badge, index }: { badge: TrustBadge; index: number }) => (
  ...
  >
    <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-secondary/20 to-secondary/5 flex items-center justify-center group-hover:from-secondary/30 group-hover:to-secondary/10 transition-all duration-300">
            ...
            <div className="lg:col-span-3">
              <FooterColumn title="Liens Rapides">
                <DynamicMenu
                  ...
                  itemClassName="text-gray-400 hover:text-secondary text-sm transition-colors duration-200 flex items-center gap-2 group"
                  showIcons={false}
                  maxDepth={1}
                />
              </FooterColumn>
