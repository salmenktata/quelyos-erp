...
const statusConfig: Record<TicketState, { label: string; className: string }> = {
  ...
  in_progress: { label: 'En cours', className: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400' },
  waiting: { label: 'En attente', className: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400' },
