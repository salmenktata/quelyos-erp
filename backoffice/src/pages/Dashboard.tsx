      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Produits</h3>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Commandes</h3>
            <p className="text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Statistiques</h3>
            <p className="text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Facturation</h3>
            <p className="text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Paramètres</h3>
            <p className="text-gray-600 dark:text-gray-400">
        ...
        <div className="mt-12 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">État du système</h3>
