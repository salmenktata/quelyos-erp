      ...
      <div className="p-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">Gérer les coupons et promotions</p>
          </div>
          <Link
            to="/coupons/create"
            className="px-4 py-2 bg-indigo-600 dark:bg-indigo-500 text-white rounded-lg hover:bg-indigo-700 transition-colors font-medium"
          >
            Créer un coupon
          </Link>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 mb-6">
          <div className="flex items-center space-x-4">
            <label className="flex items-center">
              ...
              />
              <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">Actifs uniquement</span>
            </label>
          ...
          {isLoading ? (
                  ...
                  {data.data.coupons.map((coupon) => (
                    <tr key={coupon.id} className="hover:bg-gray-50 dark:bg-gray-900 transition-colors">
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="text-sm text-gray-500 dark:text-gray-500">{coupon.program_type}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="p-8 text-center text-gray-600 dark:text-gray-400">
              <div className="max-w-md mx-auto">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Aucun coupon</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Créez votre premier code promo pour booster vos ventes
                </p>
                <Link
                  to="/coupons/create"
                  className="inline-block px-4 py-2 bg-indigo-600 dark:bg-indigo-500 text-white rounded-lg hover:bg-indigo-700 transition-colors font-medium"
                >
                  Créer un coupon
                </Link>
              </div>
