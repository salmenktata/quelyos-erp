    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <p className="text-sm font-medium text-gray-500">Nombre de locations</p>
            <p className="mt-1 text-lg font-semibold text-gray-900">{warehouse.location_count}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Locations de stock</h2>
        ...
        <div className="p-6">
          {warehouse.locations && warehouse.locations.length > 0 ? (
                ...
                >
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900">{location.complete_name}</p>
                        <p className="text-xs text-gray-500">Type: {location.usage}</p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex flex-col items-center py-12">
              ...
              <p className="mt-4 text-gray-500">Aucune location dans cet entrepôt</p>
            </div>
          )}
        </div>
      </div>
